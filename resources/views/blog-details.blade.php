                                    ...
                                    <div class="blog_details-meta">
                                        <div class="blog_details-author">
                                            ...
                                            <div class="blog_details-author-info">
                                                <span>Teacher</span>
                                                <h5><a href="{{ url('/team') }}">Dylan Meringue</a></h5>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="h2_blog-item mb-30">
                                                ...
                                                <div class="h2_blog-content">
                                                    ...
                                                    <h5 class="h2_blog-content-title"><a href="{{ url('/blog-details') }}">Education Week News and View on Education Policy and Practice.</a></h5>
                                        ...
                                        <div class="col-md-6">
                                            <div class="h2_blog-item mb-30">
                                                ...
                                                <div class="h2_blog-content">
                                                    ...
                                                    <h5 class="h2_blog-content-title"><a href="{{ url('/blog-details') }}">The Learning Network Teaching and Learning With The New York.</a></h5>
                                                    <a href="#" class="theme-btn blog-btn t-theme-btn">Read More</a>
                                                </div>
                                            </div>
                                        </div>
