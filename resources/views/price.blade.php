                                ...
                                <nav class="h2_main-menu mobile-menu" id="mobile-menu">
                                    <ul>
                                        <li class="menu-has-child">
                                            <a href="{{ url('/') }}">Home</a>
                                            <ul class="submenu">
                                                <li><a href="{{ url('/') }}">Education Main</a></li>
                                        ...
                                        <li class="menu-has-child">
                                            ...
                                            <ul class="submenu">
                                                <li><a href="{{ url('/course') }}">Courses 1</a></li>
                                        ...
                                        <li class="menu-has-child">
                                            ...
                                            <ul class="submenu">
                                                ...
                                                <li><a href="{{ url('/team') }}">Teacher</a></li>
                                                <li><a href="{{ url('/team-details') }}">Teacher Details</a></li>
                        ...
                        <div class="col-xl-2 col-lg-5 col-md-5 col-sm-6 d-flex justify-content-xl-center">
                            <div class="footer-widget mb-40">
                                ...
                                <div class="footer-widget-list">
                                    <ul>
                                        <li><a href="{{ url('/about') }}">About Hamari Product</a></li>
                                        <li><a href="{{ url('/contact') }}">Contact</a></li>
                                        <li><a href="{{ url('/contact') }}">Help Centre</a></li>
                                        <li><a href="{{ url('/about') }}">Refund</a></li>
                                        <li><a href="{{ url('/about') }}">Conditions</a></li>
