...
export default function TeacherCard({ teacher }: TeacherCardProps) {
    const profileImage = teacher.user?.details?.profileImage
        ? process.env.NEXT_PUBLIC_ASSET_URL + teacher.user?.details?.profileImage
    ...
    return (<>
        <div className="grid grid-cols-1 md:grid-cols-[3fr_1fr] gap-4 group">
            ...
            {/* LEFT / MAIN CARD */}
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex flex-col xl:flex-row gap-8 transition-all hover:shadow-lg group">
                ...
                <div className="flex-1 min-w-0">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-sm text-gray-500 font-medium mb-4">
                                <div className="flex items-center gap-1.5">
                                    ...
                                    <span>{teacher.role || "English Tutor"}</span>
                                </div>
                                <div className="flex items-center gap-1.5">
                    ...
                    {/* Metrics */}
                    <div className="flex flex-wrap items-center gap-6 mb-6 py-3 px-4 bg-gray-50 rounded-xl">
                        <div className="flex items-center gap-1.5">
                        ...
                        <div className="flex items-center gap-1.5">
                            ...
                            <span className="font-black text-gray-900">{activeStudents}</span>
                            <span className="text-gray-400 text-sm font-medium">
                                active students
                            </span>
                        </div>
                        ...
                        <div className="flex items-center gap-1.5">
                            ...
                            <span className="font-black text-gray-900">{lessons}</span>
                            <span className="text-gray-400 text-sm font-medium">lessons</span>
                        </div>
                    </div>
                    ...
                    <div className="md:hidden flex items-center justify-between pt-4 border-t border-gray-100 mt-6">
                        <div>
                            <div className="text-xl font-black text-gray-900">$</div>
                ...
                <div className="flex-1 min-w-0">
                    <div className="flex flex-row md:flex-col gap-3">
                        ...
                        <button className="flex items-center justify-center gap-2 px-8 py-3 bg-white border-2 border-gray-100 text-gray-900 font-bold rounded-xl hover:bg-gray-50 transition-all sm:w-auto">
            ...
            {/* RIGHT / SIDEBAR */}
            <div className="hidden md:flex opacity-1 
